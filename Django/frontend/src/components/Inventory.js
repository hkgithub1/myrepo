            ...
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="Search Results">
                    ...
                    <TableRow>
                        ...
                        <TableCell align="justify">Issues</TableCell>
                        <TableCell align="justify">Price</TableCell>
                        <TableCell align="justify">First Image</TableCell>
                    ...
                    <TableBody>
                        {results.map((row) => (
                            ...
                            <TableCell align="justify">{row.book_issues}</TableCell>
                            <TableCell align="justify">{row.book_price}</TableCell>
                            <TableCell align="justify">{row.first_image}</TableCell>
